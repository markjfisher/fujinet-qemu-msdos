...
QEMU tooling, and MS-DOS 6.x. Sidecar .inf files are ignored so staging
folders can coexist with BBC disk-image workflows.
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog="""\
Examples:
  scripts/create_msdos_img.py -i stage -o build/msdos-apps.img
  scripts/create_msdos_img.py -i stage -o ~/8bit/TNFS/msdos/apps.img -p 1440 -l NIOAPPS
  scripts/create_msdos_img.py -i big-stage -o ~/8bit/TNFS/msdos/big.img -s 16 -f 16
  scripts/create_msdos_img.py -i big-stage -o ~/8bit/TNFS/msdos/big.img -s 16 -f 16 -c 8
